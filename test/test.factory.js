...
tape( 'the function returns a function which throws an error if scale parameter `sigma` is not a positive number primitive', function test( t ) {
	var values;
	var i;
...
tape( 'the function returns a function which throws an error if scale parameter `sigma` is not a positive number primitive (parameters)', function test( t ) {
	var values;
	var i;
...
tape( 'the function returns a factory function which creates stream instances', function test( t ) {
	...
	for ( i = 0; i < 10; i++ ) {
		t.strictEqual( createStream( 2.0, 5.0 ) instanceof RandomStream, true, 'returns expected value' );
	}
	t.end();
});
