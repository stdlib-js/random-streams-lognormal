...
```bash
npm install @stdlib/random-streams-lognormal
```
...
```bash
npm install -g @stdlib/random-streams-lognormal
```
...
[dependencies-image]: https://img.shields.io/david/stdlib-js/random-streams-lognormal
