...
/**
* Class for creating readable streams which generate a stream of pseudorandom numbers drawn from a lognormal distribution.
*/
declare class RandomStream extends Readable {
	...
	*/
	constructor( mu: number, sigma: number, options?: Options );
	...
	*/
	...
	/**
	* Pseudorandom number generator for generating lognormally distributed pseudorandom numbers.
	*/
...
interface Constructor {
	...
	* stream.pipe( inspectStream( log )  );
	*/
	new( mu: number, sigma: number, options?: Options ): RandomStream; // newable
	...
	* stream.pipe( inspectStream( log )  );
	*/
	( mu: number, sigma: number, options?: Options ): RandomStream; // callable
	...
	* }
	*/
	factory( options?: Options ): ( mu: number, sigma: number ) => RandomStream;

	/**
	* Returns an "objectMode" readable stream for generating a stream of pseudorandom numbers drawn from a lognormal distribution.
	*
	* @param mu - location parameter
	* @param sigma - scale parameter
	* @param options - stream options
	...
	*/
	objectMode( mu: number, sigma: number, options?: Options ): RandomStream;
}
